...
public class RequestUtil {
    ...
    void sendCreated(final HttpServerExchange exchange, final MyObjectRepresentation myObjectRepresentation) {
        exchange.getResponseHeaders().put(LOCATION, exchange.getRequestPath() + "/" + myObjectRepresentation.getId());
        sendJson(exchange, myObjectRepresentation, CREATED);
    }
